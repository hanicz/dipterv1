...
var SharedNotesComponent = /** @class */ (function () {
    function SharedNotesComponent(fileService, roleService, noteService) {
    ...
    SharedNotesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.selectedNote = new file_1.MyFile();
        this.noteService.get_shared_notes().subscribe(function (json) {
            console.log(json);
            _this.notes = json;
        }, function (error) { return console.error('Error: ' + error); });
    };
    SharedNotesComponent.prototype.onSelectNote = function (note) {
        this.selectedNote = note;
    };
    SharedNotesComponent.prototype.isValid = function () {
        return this.selectedNote.created != null;
    };
    SharedNotesComponent.prototype.update_note = function () {
        var _this = this;
    ...
    SharedNotesComponent.prototype.delete_note = function () {
        var _this = this;
    ...
    return SharedNotesComponent;
}());
exports.SharedNotesComponent = SharedNotesComponent;
//# sourceMappingURL=shared-notes.component.js.map